...
public class ChocolateMousseBlock extends CakeBlock {

    protected static final VoxelShape[] BITES_TO_SHAPE;

    public ChocolateMousseBlock(int totalBites) {
        super(totalBites);
    }
    ...
    static {
        BITES_TO_SHAPE = new VoxelShape[] { Block.createCuboidShape(1D, 0D, 1D, 15D, 4D, 15D),
                Block.createCuboidShape(9D, 0D, 1D, 15D, 4D, 15D), Block.createCuboidShape(0D, 0D, 0D, 0D, 0D, 0D),
