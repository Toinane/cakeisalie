...
public class CarrotCakeBlock extends CakeBlock {
    ...
    public CarrotCakeBlock(int totalBites) {
        super(totalBites);
    }
    ...
    static {
        BITES_TO_SHAPE = new VoxelShape[] { Block.createCuboidShape(1D, 0D, 1D, 15D, 9D, 15D),
                Block.createCuboidShape(5D, 0D, 1D, 15D, 9D, 15D), Block.createCuboidShape(9D, 0D, 1D, 15D, 9D, 15D),
                Block.createCuboidShape(13D, 0D, 1D, 15D, 9D, 15D), Block.createCuboidShape(0D, 0D, 0D, 0D, 0D, 0D),
