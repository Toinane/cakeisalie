...
public class BasqueCakeBlock extends CakeBlock {

    protected static final VoxelShape[] BITES_TO_SHAPE;

    public BasqueCakeBlock(int totalBites) {
        super(totalBites);
    }
    ...
    static {
        BITES_TO_SHAPE = new VoxelShape[] { Block.createCuboidShape(1D, 0D, 1D, 15D, 5D, 15D),
                Block.createCuboidShape(7D, 0D, 1D, 15D, 5D, 15D), Block.createCuboidShape(13D, 0D, 1D, 15D, 5D, 15D),
                Block.createCuboidShape(0D, 0D, 0D, 0D, 0D, 0D), Block.createCuboidShape(0D, 0D, 0D, 0D, 0D, 0D),
                Block.createCuboidShape(0D, 0D, 0D, 0D, 0D, 0D), Block.createCuboidShape(0D, 0D, 0D, 0D, 0D, 0D),
                Block.createCuboidShape(0D, 0D, 0D, 0D, 0D, 0D) };
    }
}