...
public class CakeIsALie
{
	...
	public static Block chocolate_cake = new BlockMultipleCake("chocolate_cake").setUnlocalizedName("Chocolate_cake").setHardness(0.5F);
	public static Block apple_cake = new BlockMultipleCake("apple_cake").setUnlocalizedName("Apple_cake").setHardness(0.5F);
	public static Block gold_cake = new BlockMultipleCake("gold_cake").setUnlocalizedName("Gold_cake").setHardness(0.5F);
	public static Block trapped_cake = new BlockMultipleCake("trapped_cake").setUnlocalizedName("Trapped_cake").setHardness(0.5F);
	public static Block poisoned_cake = new BlockMultipleCake("poisoned_cake").setUnlocalizedName("Poisoned_cake").setHardness(0.5F);
	public static Block lava_cake = new BlockMultipleCake("lava_cake").setUnlocalizedName("Lava_cake").setHardness(0.5F);
	public static Block basque_cake = new BlockMultipleCake("basque_cake").setUnlocalizedName("Basque_cake").setHardness(0.5F);
	public static Block redstone_cake = new BlockMultipleCake("redstone_cake").setUnlocalizedName("Redstone_cake").setHardness(0.5F);
	public static Block brownie = new BlockMultipleCake("brownie").setUnlocalizedName("Brownie").setHardness(0.5F);
	public static Block chocolate_mousse = new BlockMultipleCake("chocolate_mousse").setUnlocalizedName("Chocolate_mousse").setHardness(0.5F);
	public static Block cookies_cake = new BlockMultipleCake("cookies_cake").setUnlocalizedName("Cookies_cake").setHardness(0.5F);
	public static Block ender_cake = new BlockMultipleCake("ender_cake").setUnlocalizedName("Ender_cake").setHardness(0.5F);
	public static Block pumpkin_cake = new BlockMultipleCake("pumpkin_cake").setUnlocalizedName("Pumpkin_cake").setHardness(0.5F);
	public static Block spiced_cake = new BlockMultipleCake("spiced_cake").setUnlocalizedName("Spiced_cake").setHardness(0.5F);
	public static Block sandy_cake = new BlockMultipleCake("sandy_cake").setUnlocalizedName("Sandy_cake").setHardness(0.5F);
	public static Block stars_cake = new BlockMultipleCake("stars_cake").setUnlocalizedName("Stars_cake").setHardness(0.5F);
	public static Block watermelon_cake = new BlockMultipleCake("watermelon_cake").setUnlocalizedName("Water-melon_cake").setHardness(0.5F);
	public static Block nordic_cake = new BlockMultipleCake("nordic_cake").setUnlocalizedName("Nordic_cake").setHardness(0.5F);
	public static Block anniversary_cake = new BlockMultipleCake("anniversary_cake").setUnlocalizedName("Anniversary_cake").setLightLevel(0.8F).setHardness(0.5F);
	public static Block paris_brest = new BlockMultipleCake("paris_brest").setUnlocalizedName("Paris_brest").setHardness(0.5F);
	public static Block hamburger = new BlockMultipleCake("hamburger").setUnlocalizedName("Hamburger").setHardness(0.5F);
	public static Block cheese_cake = new BlockMultipleCake("cheese_cake").setUnlocalizedName("Cheese_cake").setHardness(0.5F);
	public static Block chocolate_roll = new BlockMultipleCake("chocolate_roll").setUnlocalizedName("Chocolate_roll").setHardness(0.5F);
	public static Block carrot_cake = new BlockMultipleCake("carrot_cake").setUnlocalizedName("Carrot_cake").setHardness(0.5F);
	public static Block slime_cake = new BlockMultipleCake("slime_cake").setUnlocalizedName("Slime_cake").setHardness(0.5F);
	public static Block muffins = new BlockMultipleCake("muffins").setUnlocalizedName("Muffins").setHardness(0.5F);
