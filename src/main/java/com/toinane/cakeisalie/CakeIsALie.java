...
public class CakeIsALie
{
	...
	public static Block chocolate_cake = new BlockMultipleCake("chocolate_cake").setUnlocalizedName("Chocolate_cake").setSoundType(SoundType.CLOTH).setHardness(0.5F);
