...
public abstract class CommonProxy {
	...
	public static Block chocolate_cake 		= new BlockMultipleCake("chocolate_cake")	.setRegistryName("chocolate_cake")		.setUnlocalizedName("chocolate_cake")	.setHardness(0.5F);
	public static Block apple_cake 			= new BlockMultipleCake("apple_cake")		.setRegistryName("apple_cake")			.setUnlocalizedName("apple_cake")		.setHardness(0.5F);
	public static Block gold_cake 			= new BlockMultipleCake("gold_cake")		.setRegistryName("gold_cake")			.setUnlocalizedName("gold_cake")		.setHardness(0.5F);
	public static Block trapped_cake 		= new BlockMultipleCake("trapped_cake")		.setRegistryName("trapped_cake")		.setUnlocalizedName("trapped_cake")		.setHardness(0.5F);
	public static Block poisoned_cake 		= new BlockMultipleCake("poisoned_cake")	.setRegistryName("poisoned_cake")		.setUnlocalizedName("poisoned_cake")	.setHardness(0.5F);
	public static Block lava_cake 			= new BlockMultipleCake("lava_cake")		.setRegistryName("lava_cake")			.setUnlocalizedName("lava_cake")		.setHardness(0.5F);
	public static Block basque_cake 		= new BlockMultipleCake("basque_cake")		.setRegistryName("basque_cake")			.setUnlocalizedName("basque_cake")		.setHardness(0.5F);
	public static Block redstone_cake 		= new BlockMultipleCake("redstone_cake")	.setRegistryName("redstone_cake")		.setUnlocalizedName("redstone_cake")	.setHardness(0.5F);
	public static Block brownie 			= new BlockMultipleCake("brownie")			.setRegistryName("brownie")				.setUnlocalizedName("brownie")			.setHardness(0.5F);
	public static Block chocolate_mousse 	= new BlockMultipleCake("chocolate_mousse")	.setRegistryName("chocolate_mousse")	.setUnlocalizedName("chocolate_mousse")	.setHardness(0.5F);
	public static Block cookies_cake 		= new BlockMultipleCake("cookies_cake")		.setRegistryName("cookies_cake")		.setUnlocalizedName("cookies_cake")		.setHardness(0.5F);
	public static Block ender_cake 			= new BlockMultipleCake("ender_cake")		.setRegistryName("ender_cake")			.setUnlocalizedName("ender_cake")		.setHardness(0.5F);
	public static Block pumpkin_cake 		= new BlockMultipleCake("pumpkin_cake")		.setRegistryName("pumpkin_cake")		.setUnlocalizedName("pumpkin_cake")		.setHardness(0.5F);
	public static Block spiced_cake 		= new BlockMultipleCake("spiced_cake")		.setRegistryName("spiced_cake")			.setUnlocalizedName("spiced_cake")		.setHardness(0.5F);
	public static Block sandy_cake 			= new BlockMultipleCake("sandy_cake")		.setRegistryName("sandy_cake")			.setUnlocalizedName("sandy_cake")		.setHardness(0.5F);
	public static Block stars_cake 			= new BlockMultipleCake("stars_cake")		.setRegistryName("stars_cake")			.setUnlocalizedName("stars_cake")		.setHardness(0.5F);
	public static Block watermelon_cake 	= new BlockMultipleCake("watermelon_cake")	.setRegistryName("watermelon_cake")		.setUnlocalizedName("watermelon_cake")	.setHardness(0.5F);
	public static Block nordic_cake 		= new BlockMultipleCake("nordic_cake")		.setRegistryName("nordic_cake")			.setUnlocalizedName("nordic_cake")		.setHardness(0.5F);
	public static Block anniversary_cake 	= new BlockMultipleCake("anniversary_cake")	.setRegistryName("anniversary_cake")	.setUnlocalizedName("anniversary_cake")	.setHardness(0.5F).setLightLevel(0.8F);
	public static Block paris_brest 		= new BlockMultipleCake("paris_brest")		.setRegistryName("paris_brest")			.setUnlocalizedName("paris_brest")		.setHardness(0.5F);
	public static Block hamburger 			= new BlockMultipleCake("hamburger")		.setRegistryName("hamburger")			.setUnlocalizedName("hamburger")		.setHardness(0.5F);
	public static Block cheese_cake 		= new BlockMultipleCake("cheese_cake")		.setRegistryName("cheese_cake")			.setUnlocalizedName("cheese_cake")		.setHardness(0.5F);
	public static Block chocolate_roll 		= new BlockMultipleCake("chocolate_roll")	.setRegistryName("chocolate_roll")		.setUnlocalizedName("chocolate_roll")	.setHardness(0.5F);
	public static Block carrot_cake 		= new BlockMultipleCake("carrot_cake")		.setRegistryName("carrot_cake")			.setUnlocalizedName("carrot_cake")		.setHardness(0.5F);
	public static Block slime_cake 			= new BlockMultipleCake("slime_cake")		.setRegistryName("slime_cake")			.setUnlocalizedName("slime_cake")		.setHardness(0.5F);
	public static Block muffins 			= new BlockMultipleCake("muffins")			.setRegistryName("muffins")				.setUnlocalizedName("muffins")			.setHardness(0.5F);
