...
public class BlockMultipleCake extends Block {
    ...
    public ItemStack getItem(World world, BlockPos pos, IBlockState state) {
		if(cake == "chocolate_cake"){ return new ItemStack(CommonProxy.item_chocolate_cake);
		}else if(cake == "apple_cake"){ return new ItemStack(CommonProxy.item_apple_cake);
		}else if(cake == "gold_cake"){ return new ItemStack(CommonProxy.item_gold_cake);
		}else if(cake == "trapped_cake"){ return new ItemStack(CommonProxy.item_trapped_cake);
		}else if(cake == "poisoned_cake"){ return new ItemStack(CommonProxy.item_poisoned_cake);
		}else if(cake == "lava_cake"){ return new ItemStack(CommonProxy.item_lava_cake);
		}else if(cake == "basque_cake"){ return new ItemStack(CommonProxy.item_basque_cake);
		}else if(cake == "redstone_cake"){ return new ItemStack(CommonProxy.item_redstone_cake);
		}else if(cake == "brownie"){ return new ItemStack(CommonProxy.item_brownie);
		}else if(cake == "chocolate_mousse"){ return new ItemStack(CommonProxy.item_chocolate_mousse);
		}else if(cake == "cookies_cake"){ return new ItemStack(CommonProxy.item_cookies_cake);
		}else if(cake == "ender_cake"){ return new ItemStack(CommonProxy.item_ender_cake);
		}else if(cake == "pumpkin_cake"){ return new ItemStack(CommonProxy.item_pumpkin_cake);
		}else if(cake == "spiced_cake"){ return new ItemStack(CommonProxy.item_spiced_cake);
		}else if(cake == "sandy_cake"){ return new ItemStack(CommonProxy.item_sandy_cake);
		}else if(cake == "stars_cake"){ return new ItemStack(CommonProxy.item_stars_cake);
		}else if(cake == "watermelon_cake"){ return new ItemStack(CommonProxy.item_watermelon_cake);
		}else if(cake == "nordic_cake"){ return new ItemStack(CommonProxy.item_nordic_cake);
		}else if(cake == "anniversary_cake"){ return new ItemStack(CommonProxy.item_anniversary_cake);
		}else if(cake == "paris_brest"){ return new ItemStack(CommonProxy.item_paris_brest);
		}else if(cake == "hamburger"){ return new ItemStack(CommonProxy.item_hamburger);
		}else if(cake == "cheese_cake"){ return new ItemStack(CommonProxy.item_cheese_cake);
		}else if(cake == "chocolate_roll"){ return new ItemStack(CommonProxy.item_chocolate_roll);
		}else if(cake == "carrot_cake"){ return new ItemStack(CommonProxy.item_carrot_cake);
		}else if(cake == "slime_cake"){ return new ItemStack(CommonProxy.item_slime_cake);
		}else if(cake == "muffins"){ return new ItemStack(CommonProxy.item_muffins);
		}else{
